...
<meta http-equiv = "refresh" content = "300; url = https://www.goldwatch.link"/> 
    ...
    function validateForm() {
      ...
      if (y < current_price) {
      	alert("Must be greater than $" + current_price);
        return false;
        }
}
</script> 
...
<script>document.getElementById("curprice").innerHTML = parseFloat(sessionStorage.getItem("current_price")).toFixed(2);</script>
	<form name="gw-addalertform" action="insert_hi.php" onsubmit="return validateForm()" method="post">
		<p>
		...
		<p>
			...
			<input type="number" step=0.01 name="pricetarget" placeholder="Greater than current price" id="PriceTarget">
		</p>
		<p>
